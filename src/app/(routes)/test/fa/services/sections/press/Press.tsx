      ...
      <div className={styles.top}>
        ...
        >
          ...
          >
            ...
            <p>
              با استفاده از به روزترین دستگاه های چاپ افست شامل افست نرمال و
              افست یووی ما بهترین کیفیت چاپ را برای شما به ارمغان می آوریم. شما
              قادر به انتخاب از بین انواع پوشش ها و کوتینگ های متنوع مانند براق،
              مات، افکت دار، آیرودین، یووی بصورت کامل و یا موضعی هستید. این
              کوتینگ ها علاوه بر افزایش محافظت از جنس چاپی، جلوه و جذابیت خاصی
              به بسته بندی میدهند.
            </p>
          </motion.div>
        </motion.div>
