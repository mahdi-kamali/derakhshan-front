      ...
      <div className={styles.top}>
        ...
        >
          ...
          >
            ...
            <p>
              برای ارائه بسته بندی لوکس و منحصر بفرد خدماتی که در مرحله بعد از
              چاپ انجام میگیرد بسیار حائز اهمیت هستند، کوچکترین جزئیات زیباترین
              اثرها و جلوه ها را میسازد، بنابراین حتی در این مرحله باید خاص ترین
              و خلاقانه ترین ایده اجرا شود.شرکت ما با داشتن تکنولوژی روز دنیا،
              بسته بندی که چه از لحاظ بصری و چه از لحاظ استحکام و دوام بهترین و
              بی نظیرترین باشد تقدیم شما میکند.
            </p>
          </motion.div>
        </motion.div>
        ...
        <div className={styles.services}>
          {[
            ...
            },
            {
              ...
              text: "لترپرس",
              marked: "لترپرس",
              desc: "یکی از مراحل بسیار حائز اهمیت در استحکام و ایستایی نهایی جعبه ، طراحی اصولی تیغ قالب جعبه بسته بندی یا همان دایکات میباشد. با توجه به سابقه طولانی درخشان شرکت ما در ارائه بهترین مدل های دایکات و تکنیک های لترپرس، جعبه نهایی کاملا بی نقص و با استحکام و دوام بالا به شما ارائه میگردد.",
            },
            {
              img: "/images/services/hero/image-7.png",
              text: "پنجره چسبانی",
