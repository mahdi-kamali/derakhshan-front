    ...
    stories: [
      {
        ...
        description:
          "شرکت درخشان پاک تبریز، پیشرو در صنعت چاپ و بسته بندی با تجربه ای بیشتر از ۸۰ سال آماده ارائه بسته بندی های لوکس و منحصر بفرد مطابق با نیاز و سلیقه مشتریان عزیز میباشد. این افتخار ماست که با بهره گیری از به روز ترین تکنولوژی ها و امکانات  این صنعت، بتوانیم در کنار مشتریان خود به عنوان یک شریک تجاری و یک مشاور با تجربه و متخصص در خلق بینظیرترین محصولات ، در جهت ارتقای برند آن شرکت محترم گام برداریم.",
      },
      {
        title: {
